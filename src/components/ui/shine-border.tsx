...
function ShineBorder({
  ...
  return (
    <div
      ...
      className={cn(
        "relative grid h-full w-full place-items-start bg-white p-3 text-black dark:bg-black dark:text-white",
        className,
      )}
    >
      <div
